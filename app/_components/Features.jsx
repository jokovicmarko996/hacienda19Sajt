...
import pergola1 from "../../public/hero/pergolastaragradja.png";
import pergola2 from "../../public/hero/pergola2.png";
import pergola3 from "../../public/hero/pergola3.png";
...
export const BentoCard = ({ src, title, description, isComingSoon }) => {
  ...
  return (
    // <div className="relative size-full shadow-[0_0_10px_theme('colors.purple.700'))"">
      ...
      <div className="relative z-10 flex size-full flex-col justify-between p-5 text-white">
        ...
        {isComingSoon && (
          ...
          >
            ...
            <p className="relative z-20">Pogledaj</p>
          </div>
        )}
      </div>
    </div>
